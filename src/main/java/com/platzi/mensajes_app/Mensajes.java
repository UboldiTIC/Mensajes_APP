...
public class Mensajes {
    ...
    /**
     * Mensajes es nuestro modelo. Tiene toda la estructura básica para realizar todas las operaciones.
     *
     * En esta clase aplicamos todos los atributos de nuestra DB.
     */
}
